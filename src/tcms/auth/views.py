...
class LoginView(DjangoLoginView):
    ...
    def get_context_data(self, **kwargs):
        ...
        print(">>>> auth.views.py LoginView.get_context_data settings:", settings, type(settings))
        print(">>>> auth.views.py LoginView.get_context_data social_auth_backends:", social_auth_backends)
        ...
        print(">>>> auth.views.py LoginView.get_context_data data:", data)
        return data
