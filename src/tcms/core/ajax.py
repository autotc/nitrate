...
def info(request):
    ...
    print(">>>> core.ajax.py info() request.GET.get(\"format\"):".format(request.GET.get("format")))
    ...
    print(">>>> core.ajax.py info() serializers.serialize():".format(serializers.serialize(
