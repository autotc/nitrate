...
def recent(request, username):
    ...
    print(">>>> profiles.views.py recent username:{}, request.user.username:{}".format(username, request.user.username))
    ...
    print(">>>> profile views.py recent type(plans):{}".format(type(plans)))
...
def redirect_to_profile(request):
    print(">>>> profiles.views.py redirect_to_profile user-recent代表的路径：", reverse("user-recent", args=[request.user.username]))
