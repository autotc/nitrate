...
Nitrate.Utils.formSerialize = function (f) {
  ...
  console.log("formSerialize data:"+data)
  return data;
};
...
function setUpChoices(elemSelect, values, addBlankOption) {
  ...
  console.log(">>>>setUpChoices  selectedOptions:"+selectedOptions)
  console.log(elemSelect)
  console.log(selectedOptions)
  console.log(">>>>setUpChoices  values:"+values)
  ...
  console.log(">>>>setUpChoices  values:"+values)
  console.log(">>>>setUpChoices  originalSelectedIds:"+originalSelectedIds)
...
function registerProductAssociatedObjectUpdaters(productSelect, triggerProductSelect, updaters) {
  jQ(productSelect).on('change', function () {
    ...
    if (selectedOptions.length === 0 || hasEmptySelection) {
      console.log(">>进入 selectedOptions.length === 0 || hasEmptySelection")
